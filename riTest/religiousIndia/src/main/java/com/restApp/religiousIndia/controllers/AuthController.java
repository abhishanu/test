...
import com.restApp.religiousIndia.payload.ApiResponse;
import com.restApp.religiousIndia.payload.JwtAuthenticationResponse;
import com.restApp.religiousIndia.payload.LoginRequest;
import com.restApp.religiousIndia.payload.SignUpRequest;
import com.restApp.religiousIndia.payload.UserSummary;
import com.restApp.religiousIndia.repositry.UserRepository;
...
public class AuthController {
	...
	@Autowired
	UserRolesRepositry roleRepository;
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
		...
		UserRoles userRole = roleRepository.findByName(RoleName.ROLE_USER)
	...
	public UserSummary getAdminUser(@CurrentUser UserPrincipal currentUser) {
		UserSummary userSummary = new UserSummary(currentUser.getId(), currentUser.getUsername(),
				currentUser.getName());
		return userSummary;
	}
